            ...
            return new Swiper(".main-slider .slide-inner", {
                ...
                pagination: {
                    ...
                    renderCustom: function (e, t, n) {
                        return $(".main-slider .dsn-controls .dsn-numbers span.full-number").html(dsnGrid.numberText(n)), TweenLite.to(".main-slider .dsn-controls .dsn-progress .dsn-progress-indicator", 1, {
                            height: t / n * 100 + "%"
...
function toggleButton() {
    $(".image-head-contact").each(function () {
        ...
        e.to($(this).find(".box-overlay"), .5, {
            autoAlpha: 0
        }), e.staggerTo($(this).find(".contact-info-item"), .8, {
            y: 20,
            autoAlpha: 0,
            ease: Back.easeInOut.config(4)
        }, .3, 0), e.to($(this).find(".box-text"), .5, {
            autoAlpha: 0
        }, "-=0.5"), e.reverse(), $(this).find('input[type="checkbox"]').off("change"), $(this).find('input[type="checkbox"]').on("change", function () {
...
function contactValidator() {
    ...
    function t(t) {
        e("[data-dsn-bg]").each(function () {
            ...
            }(), e("a.vid").YouTubePopUp(), i().ajaxLoad(), data_overlay(), background(), initMap(), n(t),
            function () {
    ...
    function n(t) {
        let n, i = e(".filterings"),
            o = e(".filters-content");
        t && i.off("click"), i.on("click", function () {
            (n = new TimelineLite).set(o, {
                y: "0%"
            }), n.to(o, 1, {
                autoAlpha: 1
            }), n.staggerFromTo(o.find("button"), .4, {
                opacity: 0,
                y: 30
            }, {
                opacity: 1,
                y: 0,
                ease: Back.easeOut.config(1.7)
            }, .1), dsnGrid.scrollTop(".work-inner", 1)
        ...
        return {
            ...
            completeElement: function (t) {
                ...
                if (void 0 === r && (r = {
                    ...
                    }, "-=0.8"), l.parents(".v-middle-horizontal").length ? i.css("width", "max-content") : i.css("width", l.width()), l.find(".dsn-chars-wrapper").length)) {
            ...
            animateAjaxEnd: function (n) {
                this.setTitle(n), this.setBodyClass(n), this.mainRoot.html(e(n).filter(o).html()), t(!0), setTimeout(function () {
                    ...
                    t.hasClass("dsn-ajax-normal") ? a.to(t, 1, {
                        scaleY: 0
                    }) : this.completeElement(t), a.call(function () {
    ...
    function o() {
        ...
        return a.to(".header-top .header-container, .site-header ", .5, {
            ...
            paddingTop: 15,
            paddingBottom: 15
        }), a.reverse(), r.to(".header-top .header-container,  .site-header , .dsn-multi-lang", .5, {
            top: -70
    ...
    const d = function () {
        ...
        c = function () {
            ...
            return {
                ...
                allInt: function () {
                    this.clearControl(), this.headerAcne(), this.headerPigmentation(), this.headerDryskin(), this.headerProject(), this.headerAbout(), this.headerBelief(), this.headerOurwork(), this.nextProject(), this.changeColor(), this.headerPages(), this.animateFade(), this.animateSkills(), this.animateNumbers(), this.sectionWork(), this.parallaxImg(), this.parallaxImgHover(), this.moveSection(), d.scrollNavigate(), d.getListener(function () {
                ...
                headerPages: function () {
                    ...
                    c.length ? (r.on("enter", function () {
                        ...
                        t.stopPropagation(), e(this).hasClass("sound-no-mute") ? (c.get(0).muted = !0, TweenMax.to(e(this).find("svg"), .8, {
                            x: 4
                        }), TweenMax.staggerTo(e(this).find(".wave-line"), .8, {
                            autoAlpha: 0
                        }, .2)) : (c.get(0).muted = !1, TweenMax.to(e(this).find("svg"), .8, {
                            x: 0
                        }), TweenMax.staggerTo(e(this).find(".wave-line"), .8, {
                            autoAlpha: 1
                        }, .2)), e(this).toggleClass("sound-no-mute")
                ...
                headerAcne: function () {
                    ...
                    let o = e("#dsn-acne-parallax-img"),
                        ...
                        function mediaSize() { 
                            ...
                            /* Changes when we reach the min-width  */
                                ...
                                } else if (window.matchMedia('(max-width: 1368px)').matches) {
                                /* Changes when we reach the min-width  */
                                    o.length > 0 && u.to(o, 2, {
                                        width: "100%",
                                        height: "100%",
                        ...
                        s.length && (dsnGrid.convertTextLine(s.find(".title")), a.length && TweenLite.set(s.find(".dsn-chars-wrapper , .metas"), {
                        y: "+=" + a.height()
                    }), l.length && TweenLite.set(s.find(".dsn-chars-wrapper , .metas"), {
                        y: "+=" + (l.height() - 30)
                    }), u.to(s.find(".metas"), 1, {
                        force3D: !0,
                        y: "0",
                        ...
                        y: "0",
                        ease: Back.easeOut.config(1.7)
                    }, .1, 0)), a.length && u.fromTo(a, .8, {
                        y: "15%",
                        x: "5rem"
                    }, {
                        y: "0%"
                    }), l.length && u.fromTo(l, .3, {
                        y: "15%",
                        autoAlpha: 0
                    }, {
                        y: "0%",
                        autoAlpha: 1
                    }), r.length && u.staggerFromTo(r, 1, {
                        y: "15%",
                        autoAlpha: 0
                    }, {
                        y: "0%",
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="acne"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                    }), f && n.push(f), i = c = c = u = f = o = box = boxl = r = l = a = s = null
                },
                headerPigmentation: function () {
                    let i = '[data-dsn-header="pigmentation"]';
                    if (e(i).length <= 0 || e(i).hasClass("dsn-end-animate")) return i = null, !1;
                    let o = e("#dsn-pigmentation-parallax-img"),
                        box = e("#dsn-3d-L"),
                        s = e("#dsn-pigmentation-title"),
                        a = e("#dsn-pigmentation-description"),
                        l = e("#dsn-pigmentation-desc-items"),
                        r = l.find(".descrption-item"),
                        c = e(i).find(".scroll-d img"),
                        u = new TimelineLite;
                        function mediaSize() { 
                            ...
                            /* Changes when we reach the min-width  */
                                o.length > 0 && !dsnGrid.isMobile() && u.to(o, 2, {
                                    ...
                                    x: "-50%",
                                    y: "-50%"
                                }), box.length > 0 && !dsnGrid.isMobile() && u.to(box, 2, {
                                    width: "100%",
                                    height: "100%",
                                    border: "0",
                                    borderLeft: "outset",
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="pigmentation"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                    }), f && n.push(f), i = c = c = u = f = o = box = r = l = a = s = null
                },
                headerDryskin: function () {
                    let i = '[data-dsn-header="dryskin"]';
                    if (e(i).length <= 0 || e(i).hasClass("dsn-end-animate")) return i = null, !1;
                    let o = e("#dsn-dryskin-parallax-img"),
                        s = e("#dsn-dryskin-title"),
                        a = e("#dsn-dryskin-description"),
                        l = e("#dsn-dryskin-desc-items"),
                        r = l.find(".descrption-item"),
                        c = e(i).find(".scroll-d img"),
                        u = new TimelineLite;
                    o.length > 0 && !dsnGrid.isMobile() && u.to(o, 2, {
                        ...
                        height: "72.4%",
                        borderRadius: "100%",
                        borderTop: "30px solid rgb(234 212 206)",
                        borderRight: "30px solid rgb(234 212 206)",
                        borderLeft: "outset",
                        borderBottom: "outset",
                        top: "50%",
                        left: "50%",
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="dryskin"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                ...
                headerProject: function () {
                    ...
                    o.length > 0 && !dsnGrid.isMobile() && u.to(o, 2, {
                        ...
                        y: "+=" + a.height()
                    }), l.length && !dsnGrid.isMobile() && TweenLite.set(s.find(".dsn-chars-wrapper , .metas"), {
                        y: "+=" + (l.height() - 30)
                    }), !dsnGrid.isMobile() && u.to(s.find(".metas"), 1, {
                        rotationZ: "-90",
                        x: "-40%",
                        ease: Back.easeOut.config(1.7)
                    }, 0), !dsnGrid.isMobile() && u.staggerTo(dsnGrid.randomObjectArray(s.find(".dsn-chars-wrapper"), .8), 1.5, {
                        force3D: !0,
                        y: "0",
                        ease: Back.easeOut.config(1.7)
                    }, .1, 0)), a.length && u.fromTo(a, .8, {
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="project"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                    }), f && n.push(f), i = c = c = u = f = o = r = l = a = w = s = null
                },
                headerAbout: function () {
                    let i = '[data-dsn-header="about"]';
                    if (e(i).length <= 0 || e(i).hasClass("dsn-end-animate")) return i = null, !1;
                    ...
                    o.length > 0 && !dsnGrid.isMobile() && u.to(o, 2, {
                        width: "100%"
                    }), s.length && (dsnGrid.convertTextLine(s.find(".title")), a.length && TweenLite.set(s.find(".dsn-word-wrapper:first .dsn-chars-wrapper"), {
                        x: "-=" + (s.width() - 100)
                    }), 0), s.length && (dsnGrid.convertTextLine(s.find(".title")), a.length && TweenLite.set(s.find(".dsn-word-wrapper:last .dsn-chars-wrapper"), {
                        x: "+=" + (s.width() - 100)
                    }), 0), s.length && (dsnGrid.convertTextLine(s.find(".title")), a.length && TweenLite.set(s.find(".metas"), {
                        y: "+=" + a.height()
                    }), 0), l.length && TweenLite.set(s.find(".dsn-chars-wrapper , .metas"), {
                        y: "+=" + (l.height() - 30)
                    }), u.to(s.find(".dsn-chars-wrapper"), 1, {
                        rotationZ: "0",
                        opacity: "1",
                        visibility: "visible",
                        x: "0",
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="about"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                    }), f && n.push(f), i = c = c = u = f = o = r = l = a = w = s = null
                },
                headerOurwork: function () {
                    ...
                    let o = e("#dsn-ourwork"),
                        s = e("#dsn-our-title"),
                        w = e("#dsn-work--title"),
                        a = e("#dsn-ourwork-description"),
                        l = e("#dsn-ourwork-desc-items"),
                        r = l.find(".descrption-item"),
                        c = e(i).find(".scroll-d img"),
                        u = new TimelineLite;
                    o.length > 0 && !dsnGrid.isMobile() && u.to(o, 2, {
                        ...
                        x: "+=" + (s.width() - 100)
                    }), 0), l.length && TweenLite.set(s.find(".dsn-chars-wrapper"), {
                        y: "+=" + (l.height() - 30)
                    }), u.to(s.find(".dsn-chars-wrapper"), 1, {
                        rotationZ: "0",
                        opacity: "0.3",
                        ...
                        x: "0",
                        left: "0px",
                    }, u.staggerTo(dsnGrid.randomObjectArray(s.find(".dsn-chars-wrapper"), .8), 1.5, {
                        force3D: !0,
                        opacity: "1",
                        y: "0",
                        ease: Back.easeOut.config(1.7)
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="ourwork"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                    }), f && n.push(f), i = c = c = u = f = o = r = l = a = w = s = null
                },
                headerBelief: function () {
                    ...
                    if (e(i).length <= 0 || e(i).hasClass("dsn-end-animate")) return i = null, !1;
                    let o = e("#dsn-belief-parallax-img"),
                        s = e("#dsn-belief-title"),
                        a = e("#dsn-belief-description"),
                        w = e("#dsn-belief-sm-title"),
                        l = e("#dsn-belief-desc-items"),
                        r = l.find(".descrption-item"),
                        c = e(i).find(".scroll-d img"),
                        u = new TimelineLite;
                    o.length > 0 && !dsnGrid.isMobile() && u.to(o, 2, {
                        ...
                        x: "+=" + (s.width() + 400)
                    }), 0), u.to(s.find(".dsn-word-wrapper:first .dsn-chars-wrapper"), 1, {
                        opacity: "0.3",
                        visibility: "visible",
                        x: "0",
                        duration: 50
                        ...
                        y: "0",
                        ease: Back.easeOut.config(1.7)
                    }, .1, 0)), u.to(s.find(".dsn-word-wrapper:last .dsn-chars-wrapper"), 1, {
                        opacity: "0.3",
                        visibility: "visible",
                        x:"0"
                    },  u.staggerFromTo(dsnGrid.randomObjectArray(s.find(".dsn-word-wrapper:last"), .8), 1.5, {
                        force3D: !0,
                        opacity: "1"
                    }, {
                        transform: "scale(.7)",
                        delay: "1",
                        ease: Back.easeOut.config(1.7)
                    }, .1, 0)), a.length && u.fromTo(s.find(".title"), 1, {
                        y: "90%"
                    }, {
                        y: "20%"
                    }, ), a.length && u.fromTo(a, .8, {
                        y: "20%",
                        autoAlpha: 0
                    }, {
                        y: "0%",
                    ...
                    c.length && f.on("progress", function (t) {
                        TweenLite.to(e('[data-dsn-header="belief"]').find(".scroll-d img"), .3, {
                            rotation: 500 * t.progress
                        })
                    }), f && n.push(f), i = c = c = u = f = o = r = l = a = w = s = null
                },
                    ...
                    dsnGrid.convertToJQuery(t).each(function () {
                        i = e.extend(!0, {
                            ...
                            responsive: [{
                                breakpoint: 992,
                                settings: {
                                    dots: !e(this).hasClass("dsn-not-dot")
                                }
                            }]
                ...
                hamburgerOpen: function () {
                    ...
                    o.set(n.find(".icon-center"), {
                        ...
                        t.stopPropagation(), s._totalDuration > 0 || ((s = new TimelineMax({
                            ...
                            display: "flex"
                        }), s.staggerTo(i.find("ul.extend-container > li > a .dsn-title-menu"), .5, {
                            y: -30,
                            autoAlpha: 0,
                            ease: Back.easeIn.config(1)
                        }, .1), s.to(i.find("ul.extend-container > li > a .dsn-meta-menu"), .5, {
                            autoAlpha: 0
                        }, .5), s.staggerFromTo(e(this).find("ul li"), .5, {
                            x: 50,
                            autoAlpha: 0
                        }, {
                            x: 0,
...
var FindJob = (function() {

	// Variables

	var findJob = '.find-job',
		$findJob = $(findJob);

    var hideJob = '.hide-job',
		$hideJob = $(hideJob);
