...
function toggleButton() {
  $(".image-head-contact").each(function () {
    ...
    e.to($(this).find(".box-overlay"), 0.5, {
      autoAlpha: 0,
    }),
      e.staggerTo(
...
!(function (e) {
  ...
  const d = (function () {
    ...
    c = (function () {
      ...
      return {
                ...
                .on("click", function (t) {
                  t.stopPropagation(),
                    e(this).hasClass("sound-no-mute")
                      ? ((c.get(0).muted = !0),
                        TweenMax.to(e(this).find("svg"), 0.8, {
                          x: 4,
                        }),
                        TweenMax.staggerTo(
        ...
        headerAcne: function () {
          let images = [
            "../assets/img/frames/png/1.png",
            "../assets/img/frames/png/2.png",
            "../assets/img/frames/png/3.png",
            "../assets/img/frames/png/4.png",
            "../assets/img/frames/png/5.png",
            "../assets/img/frames/png/6.png",
            "../assets/img/frames/png/7.png",
            "../assets/img/frames/png/8.png",
            "../assets/img/frames/png/9.png",
            "../assets/img/frames/png/10.png",
            "../assets/img/frames/png/11.png",
            "../assets/img/frames/png/12.png",
            "../assets/img/frames/png/13.png",
            "../assets/img/frames/png/14.png",
            "../assets/img/frames/png/15.png",
            "../assets/img/frames/png/16.png",
            "../assets/img/frames/png/17.png",
            "../assets/img/frames/png/18.png",
            "../assets/img/frames/png/19.png",
            "../assets/img/frames/png/20.png",
            "../assets/img/frames/png/21.png",
            "../assets/img/frames/png/22.png",
            "../assets/img/frames/png/23.png",
            "../assets/img/frames/png/24.png",
            "../assets/img/frames/png/25.png",
            "../assets/img/frames/png/26.png",
            "../assets/img/frames/png/27.png",
            "../assets/img/frames/png/28.png",
          ];
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="acne"]').find(".scroll-d img"),
                0.3,
                {
        ...
        headerPigmentation: function () {
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="pigmentation"]').find(".scroll-d img"),
                0.3,
                {
                  rotation: 500 * t.progress,
                }
        ...
        headerDryskin: function () {
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="dryskin"]').find(".scroll-d img"),
                0.3,
                {
                  rotation: 500 * t.progress,
                }
        ...
        headerAbout: function () {
          ...
          o.length > 0 &&
            ...
            s.length &&
              ...
              a.length &&
                TweenLite.set(
                  s.find(".dsn-word-wrapper:last .dsn-chars-wrapper"),
                  {
                    x: "+=" + (s.width() - 100),
                  }
                ),
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="about"]').find(".scroll-d img"),
                1,
                {
                  rotation: 500 * t.progress,
                }
        ...
        headerOurwork: function () {
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="ourwork"]').find(".scroll-d img"),
                0.3,
                {
                  rotation: 500 * t.progress,
                }
        ...
        headerBelief: function () {
          ...
          c.length &&
            f.on("progress", function (t) {
              TweenLite.to(
                e('[data-dsn-header="belief"]').find(".scroll-d img"),
                0.3,
                {
                  rotation: 500 * t.progress,
                }
  ...
  $(".modal-toggle").on("click", function (e) {
    e.preventDefault();
    $(".view-project-popup").toggleClass("is-visible");
  });
})(jQuery);
